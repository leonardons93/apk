...
class adicionarcontato extends Component{
    renderAdicinarContanto(){
    if (!this.props.cadastro_resultado_add) {
        return(
            <View style={{flex:1}}>
      ...
      return (
          <View>
              <Text style={{fontSize:20}}>cadastro usuario com sucesso</Text>
          </View>
      )
    }
}
...
const mapStateToProps = state => (
    {
        ...
        cadastro_resultado_add:state.AppReducer.cadastro_resultado_add
    }
)
